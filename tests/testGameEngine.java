...
public class testGameEngine {
    ...
    public void buildBlock_usedPlace(){
        ...
        Block b3=new Game(GameType.FERRISWHEEL,new Position(0,2,false));
        Block b4=new Game(GameType.FERRISWHEEL,new Position(1,0,false));
        Block b5=new Game(GameType.FERRISWHEEL,new Position(1,1,false));
        Block b6=new Game(GameType.FERRISWHEEL,new Position(1,2,false));
